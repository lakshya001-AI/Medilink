...
const EmbeddingType_1 = require("./EmbeddingType");
const TextsTruncate_1 = require("./TextsTruncate");
exports.Texts = core.serialization.object({
    ...
    truncate: TextsTruncate_1.TextsTruncate.optional(),
});
