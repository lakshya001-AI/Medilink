...
//     if(patientIdDS){
//       await axios.post("http://localhost:5000/getPatientRecord", {patientIdDS});
//     }else{
//     }
//   }
...
//               />
//               <button className={Style.accessButton} onClick={getPatientRecordDetails}>Access Record</button>
//             </div>
//           </div>
//         </div>
...
//                   <div className={Style.patientRecordImageDIvDS}>
//                     <img
//                       src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVKYCBD7RqtNRCEODGO2f3xXiK4p7lwszPcw&s"
//                       alt="Record Image"
//                     />
//                   </div>
//                   <div className={Style.patientRecordInfoDivDS}>
